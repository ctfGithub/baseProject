...
public class BccAuditExcelDTO {
    ...
    @ExcelProperty(value = "最后审批人",index = 18)
    @ColumnWidth(value = 30)
    private String approvePersonName;

    @ApiModelProperty("最后审核时间")
    @ExcelProperty(value = "最后审核时间",index = 19)
    @ColumnWidth(value = 30)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date executionAt;

    @ApiModelProperty(value = "最后审批备注原因")
    @ExcelProperty(value = "最后审批备注原因",index = 20)
    @ColumnWidth(value = 30)
    private String remark;

    @ApiModelProperty(value = "审批次数")
    @ExcelProperty(value = "审批次数",index = 21)
    @ColumnWidth(value = 30)
    private Integer auditCount;

    @ApiModelProperty(value = "售点店主姓名")
    @ExcelProperty(value = "售点店主姓名",index = 22)
    @ColumnWidth(value = 30)
    private String pocOwnerName;

    @ApiModelProperty(value = "售点店主电话")
    @ExcelProperty(value = "售点店主电话",index = 23)
    @ColumnWidth(value = 30)
    private String pocOwnerPhone;

    @ApiModelProperty(value = "一级经销商ID")
    @ExcelProperty(value = "一级经销商ID",index = 24)
    @ColumnWidth(value = 30)
    private String firstWholseId;

    @ApiModelProperty(value = "一级经销商名称")
    @ExcelProperty(value = "一级经销商名称",index = 25)
    @ColumnWidth(value = 30)
